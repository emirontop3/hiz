...
/*
    ...
    $("#dosyadan-al").on("change", function (e) {
        if ($('#dosyadan-al').is(':checked')) {
            ...
            $('#dosyadan-al-2').attr("disabled", true);
        } else {
            $('#dosyadan-al').val('');
            $('#kurum-secim :input').removeAttr("disabled");
            $('#dosyadan-al-2').removeAttr("disabled");
        }
    }).change();

    $("#dosyadan-al-2").on("change", function (e) {
        if ($('#dosyadan-al-2').is(':checked')) {
            $('#dosyadan-al-2').val('checked');
            $('#kurum-secim :input').attr("disabled", true);
            $('#dosyadan-al').attr("disabled", true);
        } else {
            $('#dosyadan-al-2').val('');
            $('#kurum-secim :input').removeAttr("disabled");
            $('#dosyadan-al').removeAttr("disabled");
        }
    }).change();
